...
public class AssociatePublicIpWithServerInstanceResponse {
    ...
    private AssociatePublicIpWithServerInstanceRawResponse associatePublicIpWithServerInstanceResponse;
    ...
    @AllArgsConstructor
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public static class AssociatePublicIpWithServerInstanceRawResponse {
